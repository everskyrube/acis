...
static string object_save_file_path = "/home/panda/fyrws/src/ACIS/config/testconfig.yaml";
...
int main(int argc, char **argv)
{
  ...
  cv::VideoCapture cap("/home/sky/catkin_ws/src/ACIS/result/2.avi");
  if (!cap.isOpened())
  {
...
//  cv::VideoCapture cap("/home/sy/fyrws/src/ACIS/result/2.avi");
//  if(!cap.isOpened())
//  {
//    cout << "Could not open video file" << endl;
//    return 1;
