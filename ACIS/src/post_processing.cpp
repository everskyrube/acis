...
// static string video_save_path = "/home/sy/fyrws/src/ACIS/result/vo_flight/2.avi";
...
void depth_img_cb(const sensor_msgs::ImageConstPtr &msg)
{
  ...
  string file_path = "/home/sky/catkin_ws/src/ACIS/result/depth_post/";
  static int count = 0;
  try
  {
...
void rgb_compressed_cb(const sensor_msgs::ImageConstPtr &msg)
{
  ...
  image_rgb = a->image;
  string file_path = "/home/sky/catkin_ws/src/ACIS/result/rgb_post/";
  static int count = 0;
  try
  {
    string save_path = file_path + to_string(count) + ".jpg";
